...
#let baryon_decuplet(
  ...
  cetz.canvas(length: scale, {
    ...
    // 水平虚线
    line((-1.8, y0), (1.8, y0), stroke: dashed)
    line((-1.8, y1), (1.8, y1), stroke: dashed)
    line((-1.8, y2), (1.8, y2), stroke: dashed)
    line((-1.8, y3), (1.8, y3), stroke: dashed)
...
#let baryon_decuplet-quark(
  ...
  cetz.canvas(length: scale, {
    ...
    // 节点
    baryon_node(Dm.at(0), Dm.at(1), [$d d d$], outer_r)
    baryon_node(D0.at(0), D0.at(1), [$u d d$], outer_r)
    baryon_node(Dp.at(0), Dp.at(1), [$u u d$], outer_r)
    baryon_node(Dpp.at(0), Dpp.at(1), [$u u u$], outer_r)

    baryon_node(Sm.at(0), Sm.at(1), [$d d s$], outer_r)
    baryon_node(S0.at(0), S0.at(1), [$u d s$], outer_r)
    baryon_node(Sp.at(0), Sp.at(1), [$u u s$], outer_r)

    baryon_node(Xm.at(0), Xm.at(1), [$d s s$], outer_r)
    baryon_node(X0.at(0), X0.at(1), [$u s s$], outer_r)

    baryon_node(Om.at(0), Om.at(1), [$s s s$], outer_r)
  })
}
// 用法
